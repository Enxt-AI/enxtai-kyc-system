...
export class KycService {
  ...
  async uploadAadhaarBack(userId: string, file: MultipartFile, clientId: string = '00000000-0000-0000-0000-000000000000') {
    ...
    // Note: Aadhaar Secure QR extraction is no longer eager-scanned here.
    // The frontend client handles extraction using Dynamsoft BarcodeReader and 
    // submits the raw payload via the POST /api/v1/kyc/upload/aadhaar/qr endpoint.
